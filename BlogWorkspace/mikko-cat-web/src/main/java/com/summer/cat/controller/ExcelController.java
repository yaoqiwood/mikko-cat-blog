...
// ExcelUtils.getInstance().exportObjects2Excel(tempPath, list, data,
// Student1.class, false, os);
// os.close();
// // 不基于模板导出Excel
// ExcelUtils.getInstance().exportObjects2Excel(list, Student1.class, true,
// null, true, "E://B.xlsx");
...
// data.put("info", "学校统一花名册");
//
// classes.put("class_one",
// Arrays.asList(new Student1("1010009", "李四", "一年级一班"), new Student1("1010002",
// "古尔丹", "一年级三班")));
// classes.put("class_two", Collections.singletonList(new Student1("1010008",
// "战三", "二年级一班")));
// classes.put("class_three",
// Arrays.asList(new Student1("1010004", "萝卜特", "三年级二班"), new
// Student1("1010005", "奥拉基", "三年级二班")));
// classes.put("class_four", Collections.singletonList(new Student1("1010006",
// "得嘞", "四年级二班")));
// classes.put("class_six",
// Arrays.asList(new Student1("1010001", "盖伦", "六年级三班"), new Student1("1010003",
// "蒙多", "六年级一班")));
//
// ExcelUtils.getInstance().exportMap2Excel("/excelTemplate/map_template.xlsx",
// 0, classes, data, Student1.class,
// false, "E://C.xlsx");
// return ResponseHelper.buildResponseModel(PublicResultConstant.SUCCEED);
// }
//
...
// }
// sheets.add(new NoTemplateSheetWrapper(list, Student2.class, true, "sheet_" +
// s));
// }
...
// List<Student1> students = ExcelUtils.getInstance().readExcel2Objects(path,
// Student1.class);
...
// List<List<String>> lists = ExcelUtils.getInstance().readExcel2List(path, 1,
// 2, 0);
...
// List<Student2> students = ExcelUtils.getInstance().readExcel2Objects(path,
// Student2.class, 0, 0);
