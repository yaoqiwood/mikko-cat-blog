...
public class BaseController<T, SERVICE extends BaseService<T>> {
    ...
    public @ResponseBody Map<String, ? extends Object> search(@RequestParam long page, @RequestParam long rows,
    ...
    public @ResponseBody Map<String, ? extends Object> findItemById(@RequestParam String id) {
        try {
    ...
    public @ResponseBody Map<String, ? extends Object> createItem(@RequestBody T item) {
        try {
    ...
    public @ResponseBody Map<String, ? extends Object> deleteItemById(@RequestParam String id) {
        try {
