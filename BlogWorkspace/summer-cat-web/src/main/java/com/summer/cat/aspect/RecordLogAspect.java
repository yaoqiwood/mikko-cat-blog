...
public class RecordLogAspect extends AbstractAspectManager {
    ...
    private void logHandle(ProceedingJoinPoint joinPoint, Method method, Log log, String actionLog, long startTime,
            boolean isException, StackTraceElement[] stackTrace) {
